...
import {
  LayoutDashboard, Plus, ChevronRight, HelpCircle, MessageSquare,
  LogOut, Zap, Folder, Kanban, User, X, Check,
} from "lucide-react";
...
export function Sidebar({ trackers = [], onNewScan, onTrackerCreated }: SidebarProps) {
  ...
  return (
    <aside className="w-64 flex-shrink-0 h-screen sticky top-0 flex flex-col bg-[#0d0d14] border-r border-[#1c1c21]">
      {/* Logo */}
